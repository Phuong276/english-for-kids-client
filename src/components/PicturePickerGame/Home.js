                ...
                >
                  ...
                  <div className="p-10 flex-auto overflow-auto">
                    <p className="my-4 text-slate-500 text-3xl leading-relaxed min-w-[600px]">
                      Step 1: You have many pictures, each picture corresponds
                      to each answer in the monkey.
                      <img
                        src="https://firebasestorage.googleapis.com/v0/b/english-for-kids-daa46.appspot.com/o/files%2FScreenshot%20from%202023-06-15%2013-50-12.png?alt=media&token=98a2f437-0cf4-4957-9aa9-4b879ec31e61"
                        alt=""
                        className="w-[650px] h-[350px] pt-5"
                      />
                    </p>
                    <p className="my-4 text-slate-500 text-3xl leading-relaxed min-w-[600px] pt-10">
                      Step 2: You should click on the monkey to choose the
                      answer for the picture.
                      <img
                        src="https://firebasestorage.googleapis.com/v0/b/english-for-kids-daa46.appspot.com/o/files%2FScreenshot%20from%202023-06-15%2013-50-12%20(copy).png?alt=media&token=a77a694f-587d-4f68-8fbe-75617cc56433"
                        alt=""
                        className="w-[650px] h-[350px] pt-5"
                      />
                    </p>
                    <p className="my-4 text-slate-500 text-3xl leading-relaxed min-w-[600px] pt-10">
                      Step 3: If correct you will get points and the image will
                      be deleted, otherwise you will be deducted 1 life.
                      <img
                        src="https://firebasestorage.googleapis.com/v0/b/english-for-kids-daa46.appspot.com/o/files%2FScreenshot%20from%202023-06-15%2013-49-56.png?alt=media&token=e32d0f56-eb2b-4687-8a70-9bd9fbc9ef1f"
                        alt=""
                        className="w-[650px] h-[350px] pt-5"
                      />
                    </p>
